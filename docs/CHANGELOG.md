...
- Added design revamp manual verification runners for the remaining closeout phases:
    - `tests/manual/verify_design_revamp_phase_4_testing_verification.php`
    - `tests/manual/verify_design_revamp_phase_5_documentation_closeout.php`

### Changed

- Updated the existing Phase 2 design revamp manual verification runner to match the final header/footer/sidebar implementation and the CI-safe Vitest invocation:
    - `tests/manual/verify_design_revamp_phase_2_global_layout_implementation.php`
- Archived the design revamp track and updated its closeout artifacts:
    ...
    - `conductor/tracks.md`
- Updated the related Phase 4/closeout tickets to point at the archived track plan and record the resolved FEED-018 findings:
    ...
    - `docs/tickets/FEED-018-design-revamp-review-findings.md`
