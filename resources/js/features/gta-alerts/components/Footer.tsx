...
export const Footer: React.FC = () => {
    return (
        <footer id="gta-alerts-footer" className="hidden h-12 flex-none items-center justify-between border-t-4 border-primary bg-background-dark px-8 text-[11px] font-black tracking-widest text-white uppercase md:flex">
            <div id="gta-alerts-footer-weather" className="flex gap-8">
                <span id="gta-alerts-footer-weather-text" className="flex items-center gap-2">
