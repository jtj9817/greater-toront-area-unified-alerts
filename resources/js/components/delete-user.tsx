                        ...
                        >
                            {({ resetAndClearErrors, processing, errors }) => (
                                <>
                                    ...
                                    <DialogFooter
                                        id="delete-user-dialog-footer"
                                        className="gap-2"
                                    >
                                        <DialogClose
                                            id="delete-user-cancel-close"
                                            asChild
                                        >
                                            <Button
